...
\begin{frame}
    ...
    Experimental results for the decays of $B$ mesons that don't conform[ed] with the SM predictions.
...
\begin{frame}
    ...
    \begin{center}
        \begin{tabular}{cc}
            \includegraphics[width=0.37\textwidth]{figures/alphabeta_l.pdf} & \includegraphics[width=0.37\textwidth]{figures/alphabeta_q.pdf}
        \end{tabular}
    \end{center}
    \vspace{-0.5em}
    \begin{itemize}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=0.6\textwidth]{figures/SHAP_summary.pdf}
    \end{center}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=0.3\textwidth]{figures/evoplot_C.pdf}
        \includegraphics[width=0.3\textwidth]{figures/evoplot_alphal.pdf}
        \includegraphics[width=0.3\textwidth]{figures/evoplot_betaq.pdf}
    \end{center}
    \begin{center}
        \includegraphics[width=0.3\textwidth]{figures/SHAP_C.pdf}
        \includegraphics[width=0.3\textwidth]{figures/SHAP_al.pdf}
        \includegraphics[width=0.3\textwidth]{figures/SHAP_bq.pdf}
    \end{center}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figures/RD_BKnunu.pdf}
    \end{center}
...
\begin{frame}
    \frametitle{Updated experimental values in late 2022}
    \begin{itemize}
        \item Provisional values for $R_{D^{(*)}}$ from LHCb [https://indico.cern.ch/event/1187939].\\Overall tension remains at $3.2\ \sigma$.
        \item Values for $R_{K^{(*)}}$ superseded by LHCb, arXiv:2212:09152-3 (submitted yesterday):
        $$R_K^\mathrm{low} = 0.994\pm 0.086 \pm 0.028,\qquad R_{K^*}^\mathrm{low} = 0.927\pm 0.090 \pm 0.035,$$
        $$R_K^\mathrm{cen} = 0.949 \pm 0.041 \pm 0.022, \qquad R_{K^*}^\mathrm{cen} = 1.027 \pm 0.070 \pm 0.027.$$
        The $R_{K^{(*)}}$ anomaly has disappeared (only $0.2\ \sigma$)!
    \end{itemize}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=0.3\textwidth]{figures/evoplot_betal.pdf}
        \includegraphics[width=0.3\textwidth]{figures/evoplot_alphaq.pdf}   \end{center}
    \begin{center}
        \includegraphics[width=0.3\textwidth]{figures/SHAP_bl.pdf}
        \includegraphics[width=0.3\textwidth]{figures/SHAP_aq.pdf}
    \end{center}
