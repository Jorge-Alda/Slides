...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item {\small $C_{VL} \approx \frac{-1}{\sqrt{2}G_F\Lambda^2}\left(C_{\ell q(3)}^{\ell\ell33}+ \frac{V_{cs}}{V_{cb}}C_{\ell q(3)}^{\ell\ell 23}\right)$\,.}
    ...
    \textcolor{blue}{Loop-level corrections} break the relatio $C_9^\ell = -C_{10}^\ell$.
